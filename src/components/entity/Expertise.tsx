            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-32">
                <div className='w-full flex flex-col items-center text-center lg:text-left lg:items-start lg:w-1/2 space-y-8'>
                    ...
                    <div className="flex gap-10">
                        <div className="text-center">
                            <p className="text-2xl lg:text-4xl font-bold mb-2">100+</p>
                            <p className="text-gray-500 text-sm">Updated Material</p>
                        </div>
                        <div className="text-center">
                            <p className="text-2xl lg:text-4xl font-bold mb-2">15K</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 mt-8 lg:mt-0">
                    <div className="flex flex-col text-center lg:text-left items-center lg:items-start space-y-7">
                        <img src={squareIcon} className="w-12 h-12" alt="Material Limitations" />
                        <div>
                            <h3 className="text-lg lg:text-2xl font-bold text-secondary mb-3">Material Limitations</h3>
                            <p className="text-gray-500 text-base leading-loose px-6 lg:px-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        </div>
                    </div>
                    <div className="flex flex-col text-center lg:text-left items-center lg:items-start space-y-7">
                        <img src={pyramidIcon} className="w-12 h-12" alt="Unprofessional Mentor" />
                        <div>
                            <h3 className="text-lg lg:text-2xl font-bold text-secondary mb-3">Unprofessional Mentor</h3>
                            <p className="text-gray-500 text-base leading-loose px-6 lg:px-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        </div>
                    </div>
                    <div className="flex flex-col text-center lg:text-left items-center lg:items-start space-y-7">
                        <img src={circleIcon} className="w-12 h-12" alt="Video Quality" />
                        <div>
                            <h3 className="text-lg lg:text-2xl font-bold text-secondary mb-3">Video Quality</h3>
                            <p className="text-gray-500 text-base leading-loose px-6 lg:px-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        </div>
                    </div>
                    <div className="flex flex-col text-center lg:text-left items-center lg:items-start space-y-7">
                        <img src={yellowIcon} className="w-12 h-12" alt="High Price" />
                        <div>
                            <h3 className="text-lg lg:text-2xl font-bold text-secondary mb-3">High Price</h3>
                            <p className="text-gray-500 text-base leading-loose px-6 lg:px-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        </div>
                    </div>
                </div>
